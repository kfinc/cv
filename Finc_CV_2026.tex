...
\begin{tabularx}{\linewidth}{@{}X r@{}}
  ...
  \begin{tabular}[t]{r@{}}
    \small\textcolor{accent}{Last update: 11.09.2026}
  \end{tabular}
\end{tabularx}
...
\begin{tabularx}{\linewidth}{@{}X r@{}}
  ...
  \begin{tabular}[t]{@{}r@{}}
    ...
    \href{https://human-network-lab.github.io/}{human-network-lab.github.io} \\
...
\cventry{2020 -- present}{\textbf{Assistant Professor}, Institute of Advanced Studies, Centre for Modern Interdisciplinary Technologies, Nicolaus Copernicus University in Toru\'n, Poland. Leading the Human Network Lab, a research group studying the human brain and body as an interacting network (\href{https://human-network-lab.github.io/}{human-network-lab.github.io}).}
...
\cventry{2026 -- present}{\textbf{Co-founder}, SOMATAKT spin-off company developing rhythm-based somatic interventions.}
...
\cventry{2026}{\textbf{Visiting Researcher}, Mapping Complexity Lab, University of Barcelona, Spain (host: Mar\'ia \'Angeles Serrano). Collaboration on hyperbolic embedding of functional brain networks.}
...
\cventry{2014 -- present}{\textbf{Co-founder}, Neurodio spin-off company focusing on meaningful design; data scientist on a cognitive training study (2017).}
...
\item Bonna, K., Hulme, O.\,J., Steinkamp, S.\,R., Meder, D., van der Weij, M.\,E.\,C., Duch, W., \& Finc, K. (2026). Brain network reconfiguration during reward prediction error processing. \textit{Network Neuroscience}, 10(3), 853--883.

\item Lewartowski, A.\,B., \& Finc, K. (2026). Exploring the potential of polyrhythmic entrainment in cognitive enhancement and adaptive brain--body dynamics. \textit{Musicae Scientiae} (advance online publication).

\item Grassia, M., d'Andrea, V., Finc, K., De Domenico, M., \& Mangioni, G. (2026). Machine-enhanced reconstruction of functional connectomes unravels discriminative brain sub-systems in health and disease. \textit{Scientific Reports}, 16, 16173.
...
\item Gut, M., Binder, M., Finc, K., Szeszkowski, W. (2021). Brain activity underlying response induced by SNARC-congruent and SNARC-incongruent stimuli. \textit{Acta Neurobiologiae Experimentalis}, 81(2), 95--114.

\item Bonna, K.$^*$, Finc, K.$^*$, Zimmermann, M., Bola, {\L}., Mostowski, P., Szul, M., Rutkowski, P., Duch, W., Marchewka, A., Jednoróg, K., Szwed, M. (2021). Early deafness leads to re-shaping of global functional connectivity beyond the auditory cortex. \textit{Brain Imaging and Behavior}, 15(3), 1469--1482. $^*$equal contribution.
...
\cventry{2026 -- present}{HPN IMPAKT acceleration programme, Akces NCBR (National Centre for Research and Development), for \textit{SOMATAKT}. Budget: 300\,000 PLN.}
...
\item Finc, K. (2026). Network reconfiguration in the human brain and beyond. Cognition and Brain Plasticity Unit Seminar, University of Barcelona, Spain. \textit{Invited talk}.

\item Finc, K. (2026). Network reconfiguration in the human brain and beyond. Mapping Complexity Lab Seminar, University of Barcelona, Spain. \textit{Invited talk}.
...
\cventry{2026 -- present}{Associate Member, MishMash -- Centre for AI and Creativity, University of Oslo.}
